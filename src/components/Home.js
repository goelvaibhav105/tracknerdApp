...
<div class="isolate bg-white">
      ...
      <nav class="flex h-9 items-center justify-between" aria-label="Global">
        <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-8" src="https://d33wubrfki0l68.cloudfront.net/bfad864aea33a259d945066bbefc38f83ff0255f/8dbcc/images/tracknerd-logo-4.png" alt=""/>
          </a>
        </div>
  ...
  <main>
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-3xl pt-5 pb-22 sm:pt-18 sm:pb-10">
        <div>
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
           
          </div>
          <div>
            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Welcome to Tracknerd</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Hello {userData && userData[0].name}</p>
          </div>
       { vechileUnderUser > 0 &&   <div className='mt-2 text-center'>
            <p> You have {vechileUnderUser} Under Click Below Cards to See Details :- </p>
          </div>}
